  ...
  describe "Landing Page" do
    ...
    it "has a button for Spotify Authorization and Close when you click on Connect to Spotify to Create a Playlist" do
      ...
      within(".modal") do
        ...
        expect(page).to have_link("Authorize on Spotify", href: "https://accounts.spotify.com/authorize?client_id=#{Rails.application.credentials.spotify[:client_id]}&response_type=code&redirect_uri=http://localhost:5000/callback&scope=playlist-modify-private%20playlist-modify-public")
